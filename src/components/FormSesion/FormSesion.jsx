...
const FormSesion = () => {
    ...
    return (
        <section className=" flex items-center justify-center w-screen h-screen bg-slate-50 dark:bg-black">
            <form className=" font-mono flex flex-col bg-white shadow-md rounded-sm p-4 max-sm:w-4/5 max-md:w-1/2 max-lg:w-1/2 max-2xl:w-1/3" onSubmit={(e) => { e.preventDefault(); handleSesion(); }}>
